...
Smear::Detector BuildMatrixDetector_0_1_JHFCalo( const int radius) {
  ...
  // Perfect phi and theta, except for calo only
  // -------------------------------------------
  // total coverage of the handbook for tracker and hcal is -3.5 < eta < 3.5
  Smear::Acceptance::Zone AngleZoneTracker(ThetaFromEta ( 3.5 ),ThetaFromEta ( -3.5 ));
  Smear::Device SmearThetaTracker(Smear::kTheta, "0.0");
  SmearThetaTracker.Accept.AddZone(AngleZoneTracker);
