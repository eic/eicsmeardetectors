...
| --- | --- | --- |
|MatrixDetector_0_2, B=1.5T and B=3T | 1.1.1 | Based on the [Detector Matrix](https://physdiv.jlab.org/DetectorMatrix) from November 21 2020. This is the most up-to-date version released by the YR DWG. The implementation here aims to be completely faithful (with perfect angular resolution) to the configuration available online.|
